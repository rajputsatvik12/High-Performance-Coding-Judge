...
ExecutionResult CppExecutor::execute(const CompilationResult& compilation_result){
    ...
    int input_fd = open((path_to_tests/"input1.txt").c_str(), O_RDONLY);
    int output_fd = open((path_/"user_output1.txt").c_str(), O_WRONLY | O_CREAT | O_TRUNC, 0644);
    int error_fd = open((path_/"user_error1.txt").c_str(), O_WRONLY | O_CREAT | O_TRUNC, 0644);
    ...
    std::filesystem::path path_to_stdout = path_/"user_output1.txt";
    std::filesystem::path path_to_stderr = path_/"user_error1.txt";
